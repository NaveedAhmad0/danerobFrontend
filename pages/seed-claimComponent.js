	...
	>
	  Check
          ...
          >
              ...
              Claim Remaining : {transaction.length} / {transaction.length + transactionClaimed.length}
              </h1>
            ...
            >
              ...
              {transaction.map((item, i) => (
                ...
                >
                  ...
                  <li className="d-flex justify-content-center flex-direction-column">
                    <span className="font-weight-bold text-md">
					{item.claimDate ? (new Date(item.claimDate).toDateString() + " "+ new Date(item.claimDate).toTimeString()) : 'N/A'}  
                    </span>
                  </li>
                  <li className="d-flex justify-content-center flex-direction-column">
            ...
            >
              ...
              {transactionClaimed.map((item, i) => (
                ...
                >
                  ...
                  <li className="d-flex justify-content-center flex-direction-column">
                    <span className="font-weight-bold text-md">
                      {item.lastClaimDate ? new Date(item.lastClaimDate).toDateString() : 'N/A'}
                    </span>
                  </li>
                  <li className="d-flex justify-content-center flex-direction-column">
                    <span className="font-weight-bold text-md">
